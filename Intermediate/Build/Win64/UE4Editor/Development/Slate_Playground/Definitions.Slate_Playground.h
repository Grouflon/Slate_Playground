...
#define ORIGINAL_FILE_NAME "UE4Editor-Slate_Playground.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Slate_Playground
#define DEPRECATED_FORGAME DEPRECATED
#define SLATE_PLAYGROUND_API DLLEXPORT
